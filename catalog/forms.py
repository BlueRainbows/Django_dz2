...
class ProductFormForModerCatalog(StyleFormsMixin, forms.ModelForm):

    words = ['казино', 'криптовалюта', 'крипта', 'биржа', 'дешево', 'бесплатно', 'обман', 'полиция', 'радар']

    class Meta:
        model = Product
        fields = ('description_products', 'category', 'is_published')
...
class ProductFormForAllUser(StyleFormsMixin, forms.ModelForm):

    words = ['казино', 'криптовалюта', 'крипта', 'биржа', 'дешево', 'бесплатно', 'обман', 'полиция', 'радар']

    class Meta:
        model = Product
        fields = ('name_products', 'description_products', 'image', 'price', 'category', 'is_published')
